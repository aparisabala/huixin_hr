...
namespace App\Http\Controllers\Employee\Reset;
...
use View;
//vpx_imports
class EmployeeResetController extends Controller
{
    use BaseTrait;
    public function __construct()
    {
        $this->middleware(['guest:employee']);
        $this->lang = 'employee.reset';
    }
    ...
    {
        $data['lang'] = $this->lang;
        return view('employee.pages.reset.index')->with('data',$data);
    }
    ...
    public function sendCode(Request $request)
    {
        ...
        try {
            ...
            $user->save();
            $lang = $this->lang;
            Mail::send('employee.pages.reset.mail.send-reset-code', ['code'=>$code,'lang' => $lang], function ($message) use ($request, $user) {
            ...
            $data['view'] = View::make('employee.pages.reset.mail.verfy-code', compact('user','lang'))->render();
     ...
     public function verifyCode(Request $request)
    {
        ...
        $user = Employee::where([['uuid', '=', $request->user_uuid]])->first();
        if (empty($user)) {
        ...
        $lang = $this->lang;
        $data['view'] = View::make('employee.pages.reset.mail.set-password', compact('user','lang'))->render();
        return $this->response(['type' => "success", 'data' => $data]);
    }
    ...
    public function changePass(Request $request)
    {
        ...
        $data['extraData'] = [
            ...
            "redirect" => "employee/login?pass_changed=true"
        ];
        return $this->response(['type' => "success", 'data' => $data]);
    }
