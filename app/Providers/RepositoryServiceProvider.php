...
use App\Repositories\Admin\DataLibrary\Department\Crud\Roster\Modify\Load\AddRosterEmployee\AddRosterEmployeeLoadRepository;
...
class RepositoryServiceProvider extends ServiceProvider
{
    ...
    public function register(): void
    {
        ...
        //vpx_attach
            $this->app->bind(abstract: IAddRosterEmployeeLoadRepository::class, concrete: AddRosterEmployeeLoadRepository::class);
