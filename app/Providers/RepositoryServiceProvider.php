...
use App\Repositories\Employee\TaskManage\Crud\EmployeeTaskCrudRepository;
...
class RepositoryServiceProvider extends ServiceProvider
{
        ...
        public function register(): void
        {
            ...
            //vpx_attach
            $this->app->bind(abstract: IEmployeeTaskCrudRepository::class, concrete: EmployeeTaskCrudRepository::class);
