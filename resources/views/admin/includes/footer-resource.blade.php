<input type="hidden" id="language-pack"
  value="{{ json_encode(array_merge(Lang::get('common'), Lang::get('validation'))) }}" />
...
@endif
<div id="inflate"
  style="position: fixed;bottom: 50px;z-index: 500000;right: 10px;width: 300px;min-height: 0;background: transparent;">
</div>
