...
<div class="mt-4 p-3">
    @can('lib_department_roster_employee_crud_store')
        ...
        <form id="frmStoreLibDepartmentRosterEmployee" autocomplete="off">

            {{-- Roster ID --}}
            <input type="hidden"
                   name="lib_department_rosters_id"
                   value="{{ $data['lib_department_rosters_id'] }}">
                            ...
                            <div class="card p-2 shadow-card card-border">
                                ...
                                <div class="mb-3 mt-3 text-end">
                                    <button class="btn btn-info btn-sm" type="submit">
                                        ...
                                        {{ pxLang($data['lang'],'','common.btns.crud_action_add') }}
                                    </button>
                                </div>
