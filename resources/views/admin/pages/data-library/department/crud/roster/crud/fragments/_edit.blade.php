<div class="bg-info pl-2 page-fragment-bar">
    <span class="text-light"> <a href="{{url('admin/data-library/department/crud/roster')}}"><span class="badge badge-info cursor-pointer"> <i class='fa-solid fa-arrow-left fs-16'></i></span></a> <span class="pt-1"> {{pxLang($data['lang'],'update')}}   </span> </span>
</div>
<div class="mt-4 p-3">
    @can('lib_department_roster_crud_edit')
        <form id="frmUpdateLibDepartmentRoster" autocomplete="off">
            @method('PATCH')
                        ...
                        <div class="col-md-4">
                            <div class="card p-2 shadow-card card-border">
                                ...
                                <div class="form-group text-left mb-3">
                                    ...
                                    <div class="input-group">
                                        <input type="text" class="form-control dp-roster" name="start_date" id="start_date" value="{{$data['item']?->start_date}}">
                                    </div>
                                </div>
                                <div class="form-group text-left mb-3">
                                    <label class="form-label"> <b>{{pxLang($data['lang'],'fields.end_date')}}</b> <em class="required">*</em> <span id="end_date_error"></span></label>
                                    <div class="input-group">
                                        <input type="text" class="form-control dp-roster" name="end_date" id="end_date" value="{{$data['item']?->end_date}}">
                                    </div>
                                </div>
