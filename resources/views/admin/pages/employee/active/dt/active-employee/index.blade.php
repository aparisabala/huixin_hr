...
@section('page')
    <div class="row">
        <div class="col-md-12">
            @can('active_employee_dt_view')
                <div class="">
                    @include('admin.pages.employee.active.dt.active-employee.fragments._breadcum')
                            ...
                            <div id="defaultPage" class="table-list pages">
                                <div class="mt-2 p-2 p-md-4">
                                    ...
                                    @if(count($data['items']) > 0)
                                        ...
                                        @include('common.view.fragments._pdf-layout',['docTitle' => 'ActiveEmployee List'])
                                        <div class="table-responsive">
                                            <table class="table table-bordered dt-responsive nowrap dataTable no-footer dtr-inline collapsed" id="dtActiveEmployee"></table>
                                        </div>
                                    @else
