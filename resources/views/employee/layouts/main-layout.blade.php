...
<head>
    @include('employee.includes.header-resource', ['tabTitle' => $tabTitle ?? 'Site Title'])
</head>
...
<body>
    ...
    <div id="layout-wrapper">
        ...
        @include('employee.includes.main-nav')
    ...
    @include('employee.includes.footer-resource', ['react' => $react ?? []])
</body>
</html>
