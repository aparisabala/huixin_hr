@extends('employee.layouts.full-page-layout',["tabTitle" => config('i.service_name').' | '.pxLang($data['lang'],'breadCum.title') ])
@section('page')
        ...
        <div class="row">
            <div class="col-lg-12">
                <div class="text-center">
                    <a href="{{ url('employee/login') }}" class="mb-5 d-block auth-logo">
            ...
            <div class="col-md-8 col-lg-6 col-xl-5">
                ...
                <div class="card call-center-card">
                    <div class="card-body p-4">
                        ...
                        <div class="p-2 mt-4">
                            <form id="frmEmployeeLogin" class="mb-3" autocomplete="off" method="POST">
                                <div class="mb-3">
                                ...
                                <div class="mb-3">
                                    <div class="float-end">
                                        <a href="{{ url('employee/reset')}}" class="text-muted">{{pxLang($data['lang'],'fields.forgot_password')}}</a>
                                    </div>
