<div class="bg-info pl-2 page-fragment-bar">
    <span class="text-light">
        <a href="{{ url('employee/task-manage') }}">
...
<div class="mt-4 p-3">
    {{-- @can('employee_task_crud_edit') --}}
    <form id="frmUpdateEmployeeTask" autocomplete="off">
        @method('PATCH')
        ...
        <div class="card p-2 shadow-card card-border">
            ...
            <div class="form-group text-left mb-3">
                ...
                <div class="input-group">
                    <input type="text" class="form-control" name="short_description" id="short_description" value="{{ $data['item']?->short_description }}">
                </div>
            </div>
            ...
            <div class="form-group text-left mb-3">
                ...
                <div class="input-group">
                    <textarea class="form-control long_description" name="long_description" id="long_description">{{ $data['item']?->long_description }}</textarea>
                </div>
            </div>

            <div class="mb-3 mt-3 text-end">
                <button class="btn btn-info btn-sm" type="submit">
                    <i class="fa fa-save"></i> {{ pxLang($data['lang'], '', 'common.btns.crud_action_update') }}
                </button>
            </div>
        </div>
    </form>
